...
class VLNBERT(nn.Module):
    def __init__(self, feature_size=2048+128):
        ...
        #self.reason_projection = nn.Linear(2, 1)
        self.reason_projection = nn.Linear(2*hidden_size, hidden_size)
    ...
    def forward(self, mode, sentence, token_type_ids=None,
        ...
        if mode == 'language':
            ...
            h_t, logit, attended_language, attended_visual, vision_output = self.vln_bert(mode, state_feats,
            ...
            return state_proj, logit, vision_output
