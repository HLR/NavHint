...
class Param:
    def __init__(self):
        ...
        # reasoner
        self.parser.add_argument('--prefix_length', type=int, default=10)
        self.parser.add_argument('--prefix_length_clip', type=int, default=10)
        self.parser.add_argument('--mapping_type', type=str, default='mlp', help='mlp/transformer')
        self.parser.add_argument('--is_rn', dest='is_rn', default=True, action='store_true')
