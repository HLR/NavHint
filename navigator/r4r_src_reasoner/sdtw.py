...
if __name__ == '__main__':
    ground_path = "/localscratch/zhan1624/VLN-speaker/data/r4r/R4R_val_unseen.json"
    predict_path = "/localscratch/zhan1624/VLN-interactive/snap/test_r4r/submit_val_unseen.json"
    ...
    with open(ground_path) as f1, open(predict_path) as f2:
