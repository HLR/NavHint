...
class R2RBatch():
    ...
    def __init__(self, feature_store, batch_size=100, seed=10, splits=['train'], tokenizer=None,
        ...
        for split in splits:
            if split == "train":
                with open("/egr/research-hlr/joslin/r4r/reason_text/train.json") as f_train:
        ...
        # with open("/egr/research-hlr/joslin/r4r/reason_text/train.json", 'w') as f_out:
    ...
    def _get_obs(self):
        ...
        for i, (feature, state) in enumerate(self.env.getStates()):
            ...
            if 'instr_encoding' in item:
                ...
                try:
                    obs[-1]['reason_encoding'] = torch.tensor(item['reason_encoding'][state.location.viewpointId])
                    obs[-1]['reason_mask'] = torch.tensor(item['reason_mask'][state.location.viewpointId])
