...
class VLNBert(BertPreTrainedModel):
    ...
    def forward(self, mode, input_ids, token_type_ids=None,
        ...
        if mode == 'language':
            ...
            attended_visual_for_gen = visual_attention_probs * img_embedding_output

            return pooled_output, visual_action_scores, attended_language, attended_visual, attended_visual_for_gen
